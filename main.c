...
void Duzenle()
{
    ...
    char Aranan[100];
    Personel perD;
    printf("Düzenlenecek Personelin Adýný Giriniz.");
    scanf("%s",Aranan);
...
void KayitSil()
{
    ...
    do
    {
        ...
        printf("Kaydý silinecek  Personelin TC'sini Giriniz:\n");
        scanf("%ld",&SilinenTc);
        ...
        if(kontrol!=0)
        {
            ...
            printf("Baþka Kayýt Silmek Ýstiyor musunuz?<y-Evet/n-Hayýr>\n");
            scanf("%s",secim1);
